...
public:
    ...
    */
    ...
    rank(): rank of the current process in this group. If not in the group,
        return UNDEFINED.
    is_null():  test whether the group is a null instance. Note that an empty 
    ...
    translate_ranks(): provide the ranks of processes in the current group, 
        query their ranks in `othergroup`.
    compare(): compare two groups. May return IDENT, SIMILAR or UNEQUAL. See
